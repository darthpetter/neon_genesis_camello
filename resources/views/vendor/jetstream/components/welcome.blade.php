<div class="p-6 sm:px-20 bg-white border-b border-gray-200">
    ...
    <div class="mt-8 text-2xl text-medium header-title text-guayaquil-600">
        Bienvenido a CamellaYa
    </div>

    <div class="mt-6 text-gray-500">
        Plataforma para la publicación y postulación de oportunidades laborales en el areas de los oficios/servicios empíricos.
    </div>
</div>
<!--
